...
func (this *Attribute) Add(child Node) os.Error {
	return os.NewError("Adding a child to an attribute is not supported.")
}
func (this *Attribute) Children() []Node {
	return make([]Node, 0)
}
func (this *Attribute) Set(key, value string) os.Error {
	this.name = key
	this.value = value
	return nil
}
...
func (this *Element) Add(child Node) os.Error {
...
func (this *Element) Set(key, value string) os.Error {
...
func (this *Text) Add(child Node) os.Error {
	return os.NewError("Adding a child to a text node is not supported.")
}
func (this *Text) Children() []Node {
	return make([]Node, 0)
}
func (this *Text) Set(key, value string) os.Error {
	return os.NewError("Setting an attribute on a text node is not supported.")
}
